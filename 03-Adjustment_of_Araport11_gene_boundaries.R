...
# We combined DR-Seq datasets from Schurch et al., 2014 (PMID 24722185) and Sherstnev et al., 2012 (PMID 22820990);
# Alignment of these DR-Seq datasets was detailed in https://github.com/Maxim-Ivanov/Kindgren_et_al_2019/03-Alignment_GRO-Seq_RNA-Seq_DR-Seq.sh;
# Both TSS-Seq and DR-Seq data were used to call coordinates of tag clusters by the CAGEfightR package as detailed in https://github.com/Maxim-Ivanov/Kindgren_et_al_2019/10-Call_TSS_and_PAS_clusters.R
...
# Load TSS clusters called from TSS-Seq data on WT samples (see https://github.com/Maxim-Ivanov/Kindgren_et_al_2019/10-Call_TSS_and_PAS_clusters.R):
